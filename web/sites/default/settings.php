...
$databases['default']['default'] = [
  'database' => '',
  'username' => '',   // o el usuario real que uses
  'password' => '',
  'host' => '',
  'driver' => 'mysql',
  'prefix' => '',
  'collation' => 'utf8mb4_general_ci',
  'pdo' => [
    PDO::MYSQL_ATTR_SSL_CA => 'sites/default/BaltimoreCyberTrustRoot.crt.pem',
    PDO::MYSQL_ATTR_SSL_VERIFY_SERVER_CERT => false, // Importante para Azure
  ]
];
$settings['hash_salt'] = 'cancilleria_hash_salt_2025_xk392jf83jf93';
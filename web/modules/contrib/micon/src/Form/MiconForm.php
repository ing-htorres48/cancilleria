...
/**
 * Allows for administration of Micon entity.
 *
...
class MiconForm extends EntityForm {
  ...
  /**
   * The uploaded micon package.
   *
   * @var array|null|false|\Drupal\file\FileInterface
   */
  protected $file;
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['file'] = [
      ...
      '#description' => [
        ...
        '#description' => $this->t('An IcoMoon font package. <a target="_blank" href="https://icomoon.io/app/#/select">Generate & Download</a><br><strong>Note</strong>, that only official packages generated from <a target="_blank" href="https://icomoon.io">https://icomoon.io</a> are supported.'),
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addStatus($this->t('Created the %label Micon package.', [
          '%label' => $micon->label(),
        ]));
        break;

      default:
        $this->messenger()->addStatus($this->t('Saved the %label Micon package.', [
          '%label' => $micon->label(),
        ]));
    }
    drupal_flush_all_caches();
    $form_state->setRedirectUrl($micon->toUrl('collection'));
    return $status;
  }
